...
// [synth shim] explicit decl(s) for implicit continuous-assign net(s) (DC HDL Compiler strictness)
wire shift_en;wire valid_pix;
...
always @(posedge clk_100mhz or posedge reset)  // [synth shim] dropped illegal 2nd clock edge 'or posedge clk' (ASIC: clk sampled as a level)
begin
    if(reset)
    begin
        flag <= 0;
