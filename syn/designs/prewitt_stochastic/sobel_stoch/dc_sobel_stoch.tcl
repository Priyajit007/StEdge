...
## Source   : sobel_stoch.v     (top module: sobel_stoch)
## Clocks   : clk, clk_100mhz
...
# --- read & elaborate RTL --------------------------------------------------
set RTL_FILES [list "sobel_stoch.v"]
foreach f $RTL_FILES {
    puts "Analyzing: $f"
...
set NONCLK_INPUTS [remove_from_collection [all_inputs] [get_ports {clk clk_100mhz}]]
set DELAY_OUTPUTS [all_outputs]
set_input_delay  -max 100 -clock [get_clocks clk] $NONCLK_INPUTS
set_output_delay -max 100 -clock [get_clocks clk] $DELAY_OUTPUTS
