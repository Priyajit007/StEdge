...
## Source   : read_write_controller.v     (top module: read_write_controller)
## Clocks   : clk
...
set DESIGN     "read_write_controller"
set TOP        "read_write_controller"
...
# --- read & elaborate RTL --------------------------------------------------
set RTL_FILES [list "read_write_controller.v"]
foreach f $RTL_FILES {
    puts "Analyzing: $f"
...
set NONCLK_INPUTS [remove_from_collection [all_inputs] [get_ports {clk}]]
