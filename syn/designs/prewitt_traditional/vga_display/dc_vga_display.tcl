...
## Source   : vga_display.v     (top module: vga_display)
## Clocks   : clk_100mhz, p_clk
...
# --- read & elaborate RTL --------------------------------------------------
set RTL_FILES [list "vga_display.v"]
foreach f $RTL_FILES {
    puts "Analyzing: $f"
...
create_clock -name p_clk -period $CLK_PERIOD_PS [get_ports p_clk]
...
set NONCLK_INPUTS [remove_from_collection [all_inputs] [get_ports {clk_100mhz p_clk}]]
